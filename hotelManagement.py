            ...
            with open(inputconfilname) as inputfile:
                ...
                for line in inputfile:
                    ...
                    if input_array[0] == "wakeup":
                        cursor.execute("INSERT INTO TaskTimes "
                                       "VALUES(?,?,?)", (index, input_array[1], input_array[3],))
                        cursor.execute("INSERT INTO Tasks "
                                       "VALUES(?,?,?)",(index, input_array[0], input_array[2],))
                        index += 1
                        
                    elif input_array[0] == "room":
                        cursor.execute("INSERT INTO Rooms "
                                       "VALUES(?)", (input_array[1],))
                        if len(input_array) > 3:
                            cursor.execute("INSERT INTO Residents "
                                           "VALUES(?,?,?)", (input_array[1],input_array[2], input_array[3],))
                        ...
                        cursor.execute("INSERT INTO TaskTimes "
                                       "VALUES(?,?,?)", (index, input_array[1], input_array[2],))
                        cursor.execute("INSERT INTO Tasks "
