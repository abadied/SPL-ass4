    ...
    with dbcon:
        ...
        if not databaseexisted:
            ...
            cursor.execute("CREATE TABLE TaskTimes "
                           "(TaskId INTEGER PRIMARY KEY NOT NULL ,DoEvery INTEGER NOT NULL,NumTimes INTEGER NOT NULL)")

            # create table Tasks
            cursor.execute("CREATE TABLE Tasks "
                           "(TaskId INTEGER NOT NULL REFERENCES TaskTimes(TaskId) ,TaskName TEXT NOT NULL,Parameter INTEGER)")
            ...
            cursor.execute("CREATE TABLE Residents "
                           "(RoomNumber INTEGER NOT NULL REFERENCES Rooms(RoomNumber), FirstName TEXT NOT NULL, LastName TEXT NOT NULL)")
